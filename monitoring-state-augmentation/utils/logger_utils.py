...
class LambdasImportanceSamplerLogger(Logger):
    def __init__(self, data, log_path):
        super(LambdasImportanceSamplerLogger, self).__init__(data=data, log_metric='importance-sampled-lagrangian', log_path=log_path)
