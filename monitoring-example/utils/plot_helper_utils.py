...
import logging
logging.getLogger('matplotlib.font_manager').setLevel(logging.ERROR) # suppress findFont warnings


def hdr_plot_style(activate = True):
    if activate:
        ...
        # mpl.rcParams['font.sans-serif'] = 'Times New Roman' # 'Courier New'
